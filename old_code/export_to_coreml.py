...
parser.add_argument(
    ...
    type=str,
    required=True,
    help="Name of the module/file containing the model class"
)
parser.add_argument(
    "--model_name",
    type=str,
...
coreml_model = ct.convert(
    ...
    convert_to=format,
    # Require >= MacOS 15 to ensure opset >= 7
...
print(
    f"Quantized model size: {os.path.getsize('weights/CoreML_Craft_.mlmodel')/1e6:.2f} MB")
